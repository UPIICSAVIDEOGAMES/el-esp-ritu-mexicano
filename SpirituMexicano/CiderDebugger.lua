...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/sergio/Library/Application Support/luaglider2/dev";local SOCKET_PORT=37555;local GLIDER_MAIN_FOLDER= "/Users/sergio/el-esp-ritu-mexicano/SpirituMexicano";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
