...
local function btnTap(event)
	if nombre ~= "" and edad > 0 then
            base.insert("usuario", "id, nombre, edad", " 1, '"..nombre.."', "..edad.."")
...
function scene:create( event )
	...
	local overlay = scene:crearImagen("images/inst_09.png", display.contentWidth, display.contentHeight+50,centerX,centerY,group)
        ...
        tap = display.newText(group,"Dinos tu nombre",centerX, centerY, "fonts/BELLABOO-Regular", 80)
        ...
        defaultField.placeholder = "dinos tu nombre"
